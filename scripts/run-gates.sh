...
capture drift-check-positive pass pnpm exec drift-check docs --pinned-version 0.9.8
...
capture drift-check-negative fail pnpm exec drift-check "$DRIFT_TMP/docs" --pinned-version 0.9.8
rm -rf "$DRIFT_TMP"
