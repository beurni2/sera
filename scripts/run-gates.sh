...
capture drift-check-positive pass pnpm exec drift-check docs --pinned-version 3.11.0
...
capture drift-check-negative fail pnpm exec drift-check "$DRIFT_TMP/docs" --pinned-version 3.11.0
rm -rf "$DRIFT_TMP"
